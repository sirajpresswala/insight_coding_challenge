...
rolling_median = []
looplist = [0]
df = pd.DataFrame(pd.read_csv(r'C:\Users\ADMIN\Desktop\venmo-trans.txt',header=None,index_col=None,sep=';',squeeze=True).apply(lambda x: ast.literal_eval(x)).tolist())
...
for i in looplist:
  try:
    ...
    pass
f = open(r'C:\Users\ADMIN\Desktop\coding_challenge_output.txt','w')
simplejson.dump(rolling_median,f)
f.close()
    
#comments:
# import libaries pandas, numpy, ast
